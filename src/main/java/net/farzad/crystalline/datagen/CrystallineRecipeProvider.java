    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registryLookup, RecipeOutput exporter) {
        return new RecipeProvider(registryLookup, exporter) {
            ...
            public void buildRecipes() {
                shaped(RecipeCategory.BUILDING_BLOCKS, CrystallineBlocks.AMETHYST_BRICKS, 4)
                        .define(Character.valueOf('#'), Blocks.AMETHYST_BLOCK)
                        .pattern("##").pattern("##")
                        .unlockedBy(RecipeProvider.getHasName(Blocks.AMETHYST_BLOCK), has(Blocks.AMETHYST_BLOCK))
                        .save(this.output);
